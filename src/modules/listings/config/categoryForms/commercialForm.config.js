...
const COMMERCIAL_BODY_TYPES = [
  "Ambulance Body", "Box Body", "Bus Body", "Cargo Body", "Car Carrier",
  "Car Transporter", "Chassis Cab", "Coach Body", "Container Body",
  "Crew Cab", "Curtain Side", "Dropside", "Dump Body", "Flatbed",
  "Food Truck Body", "High Roof Van", "Insulated Body", "Low Roof Van",
  "Luton Body", "Mixer Body", "Panel Van", "Passenger Van",
  "Platform Body", "Refrigerated Body", "Service Body", "Sleeper Cab",
  "Stake Body", "Standard Cab", "Tank Body", "Tipper Body",
  "Tractor Unit", "Van Body", "Wheel Lift Body",
];
...
export const commercialFormConfig = {
  ...
  vehicleInfoFields: [
    ...
    { name: "vehicleType", label: "Vehicle Type", type: "select", required: true, options: COMMERCIAL_TYPES },
    ...
    { name: "bodyType", label: "Body Type", type: "select", required: true, options: COMMERCIAL_BODY_TYPES },
